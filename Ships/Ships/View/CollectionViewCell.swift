...
class MyCollectionViewCell: UICollectionViewCell {
    ...
    func setCell(_ ship: Ship, index: Int = 0) {
        
        let shipView = ShipView(ship: ship, index: index, frame: CGRect(x: 0, y: 0, width: 150, height: 140))
...
//
//        let shipView = ShipView(ship: ship)
//
//        self.addSubview(shipView)
//
//    }
